...
`agent_reach.execution.v1` exposes thirty-three closed operations: two RSS,
four Bilibili, three YouTube, four V2EX, two Exa, seven Reddit, four Facebook,
four Instagram, one Twitter, one Xiaohongshu, and one Xueqiu
...
configuration. Xueqiu accepts a one-attempt trusted-host session, and Exa Web
and Code use distinct fixed MCP methods. Each descriptor fixes its command
and schema; callers cannot
